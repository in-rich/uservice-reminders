...
var getReminderFixtures = []*entities.Reminder{
	{
...
func TestGetReminder(t *testing.T) {
	...
	stx := BeginTX(db, getReminderFixtures)
	...
	for _, tt := range testData {
		t.Run(tt.name, func(t *testing.T) {
			...
			repo := dao.NewGetReminderRepository(tx)
			reminder, err := repo.GetReminder(context.TODO(), tt.authorID, tt.target, tt.publicIdentifier)
